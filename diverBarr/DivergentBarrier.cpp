        ...
        bool runOnFunction(Function &F) override {
            ...
            for (Instruction &I : instructions(F)) {
                ...
                // *** ADD THIS CHECK ***
                // Only consider divergence if the barrier block is an immediate
                // successor of the diverging branch. This handles Case D correctly.
            ...
            if (!DivergentBarriers.empty()) {
                ...
                outs() << "[RESULT]   Potential Divergent Barrier Detected at line " << line
                        << ":\n";
                barrier->print(outs());
                outs() << "\n";
                }
            } else {
                outs() << "[RESULT]   No divergent barriers detected for " << F.getName()
                    << ".\n";
            }
